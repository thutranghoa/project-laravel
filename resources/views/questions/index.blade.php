            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-around">
                        ...
                        <form action="{{ route('quizzes.exercises.questions.destroy', [$quiz->id, $exercise->id, $question->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this question?')" class="mx-1">
                            @csrf
                            @method('DELETE')
